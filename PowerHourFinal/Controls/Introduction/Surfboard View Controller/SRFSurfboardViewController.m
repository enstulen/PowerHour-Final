...
- (void)buttonTapped:(UIButton *)button
{
    ...
    UINavigationController *viewController = [storyboard instantiateViewControllerWithIdentifier:@"viewController"];
    BOOL ranBefore = [[NSUserDefaults standardUserDefaults] boolForKey:@"firstlaunch1.0"];
    if (!ranBefore) {
//      [self performSegueWithIdentifier:@"viewControllerSegue" sender:self];
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"firstlaunch1.0"];
