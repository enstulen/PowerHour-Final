...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, SRFSurfboardDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        SHFlatButton.appearance().shadowHeight = 6
        ...
        if (NSUserDefaults.standardUserDefaults().boolForKey("HasLauncedOnce")){
            
            
        }
        else{
            NSUserDefaults.standardUserDefaults().setBool(true, forKey: "HasLauncedOnce")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.stulen.PowerHourFinal" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("PowerHourFinal", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("PowerHourFinal.sqlite")
